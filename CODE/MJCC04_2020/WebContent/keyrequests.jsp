        ...
        <div class="col-md-9 pl-md-5 pb-5 pl-0 probootstrap-inside" id="reg">
          ...
          <div class="row">
            ...
            <th>SEND KEY</th>
              ...
              <%
              ResultSet r=DbConnection.getResquests();
        		  while(r.next())
        		  {
        			  ...
        			  <tr>
        			  <td><%= r.getString(2) %> <input type="hidden" class="" name="email" value="<%= r.getString(2) %>" ></td>
        			  <td><%= r.getString(3) %> <input type="hidden" class="" name="fid"  value="<%= r.getString(3) %>"></td>
        			  <td> <input type="text" class="" name="fkey"></td>
        			  <td><input type="submit" value="Send Key" class="w3-button w3-green"></td>
        			  </tr>
        			  </form>
        			  <% 
        		}
