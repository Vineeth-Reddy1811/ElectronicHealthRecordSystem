<%@page import="com.testing.ReadXMLFile"%>
  ...
  <section class="probootstrap-services">
    <div class="container">
      <div class="row no-gutters">
        ...
        String[] s=ReadXMLFile.readXml(fid, fkey);
        			
        %>
        <div class="col-md-9 pl-md-5 pb-5 pl-0 probootstrap-inside" id="reg">
          <h1 class="mt-4 mb-4">FILE ID: <%= s[0] %></h1>
          <div class="row">
            <div class="col-md-12">
            <form action="DeleteFile" method="post" class="probootstrap-form">
                <div class="form-group">
                  <label for="name" class="sr-only">Title </label>
                  <input type="text" class="form-control" name="title" value="<%= s[1] %>" placeholder="Enter Title">
                  <input type="hidden" name="fid" value="<%= s[0] %>">
                </div>
                  <div class="form-group">
                  <label for="Mobile" class="sr-only">Key Words</label>
                  <input type="text" class="form-control" name="keys" value="<%= s[2] %>" placeholder="Enter Keywords (keyword1,keyword2,...)">
                	</div>
               <div class="form-group">
                  <label for="Gender" class="sr-only">Reference</label>
                  <input type="text" class="form-control" name="ref" value="<%= s[3] %>" placeholder="Enter Reference Name">
                </div>
                  <div class="form-group">
                  <label for="message" class="sr-only">Message</label>
                  <textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="Write your message"><%= s[4] %></textarea>
                </div>
