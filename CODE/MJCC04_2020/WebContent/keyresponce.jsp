    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="probootstrap-nav">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active"><a href="userhome.jsp" class="nav-link pl-0">Home</a></li>
          <li class="nav-item"><a href="searchingdata.jsp" class="nav-link">Search</a></li>
          <li class="nav-item"><a href="keyresponce.jsp" class="nav-link">Key Responses</a></li>
    ...
    <div class="container">
      <div class="row no-gutters">
        <div class="col-md-3 pb-5 probootstrap-aside-stretch-left probootstrap-inside">
          <div class="mb-3 pt-5">
            ...
            <ul class="list-unstyled probootstrap-light mb-4">
                    <li><a href="searchingdata.jsp">Searching data</a></li>
        ...
        <div class="col-md-9 pl-md-5 pb-5 pl-0 probootstrap-inside" id="reg">
          <h1 class="mt-4 mb-4">User Home</h1>
          <div class="row">
            <div class="col-md-12">
            ...
            <th>DECRYPT</th>
              ...
              ResultSet r=DbConnection.getResponses(email);
        		  while(r.next())
        		  {
        			  if(r.getString(2).equals(email))
        			  {
        			  %>
        			  <tr>
        			  <td><%= r.getString(3) %></td>
        			  <td> <input type="text" class="" name="fkey" value="<%= r.getString(4) %>"></td>
        			  <td><a href="DeleteKey?rid=<%= r.getString(1) %>">Delete Key</a></td>
        			  </tr>
        			  <% 
        			  }
        		}
